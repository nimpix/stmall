...
<? if ($_GET["sort"] == "name" ||
	...
	$arParams["ELEMENT_SORT_FIELD2"] = $_GET["sort"];
	if ($_GET["sort"] == "price"){
		$arParams["ELEMENT_SORT_FIELD"] = "catalog_PRICE_1";
		$arParams["ELEMENT_SORT_FIELD2"] = "catalog_PRICE_1";
	}
	$arParams["ELEMENT_SORT_ORDER"] = $_GET["method"];
	$arParams["ELEMENT_SORT_ORDER2"] = $_GET["method"];
}else{}?>


	<div class="filter<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		...
		<? if ($isFilter): ?>
			<div class="bx-sidebar-block">
				...
				if($_SERVER["REQUEST_URI"] == '/catalog/'){
					...
					$getSectionFilter = $arCurSection['ID'];
					$APPLICATION->IncludeComponent(
...
<?endif?>
<div class="<?=(($isFilter || $isSidebar) ? "content-bar" : "col-xs-12")?>">
	<div class="row">
        <div class="col-xs-12">
