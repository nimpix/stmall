                    ...
                    <div class="delivery-1">
                        <ul>
                          <div><span>Доставка</span></div>
                            <li>Не подавайте одно и то же объявление несколько раз</li>
                            <li>Не указывайте телефон, email или адрес сайта в описании или на фото</li>
                            <li>Не пишите цену в названии — для этого есть отдельное поле</li>
