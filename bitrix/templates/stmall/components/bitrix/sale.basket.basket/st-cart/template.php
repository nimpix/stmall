...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<div id="basket-root" class="container bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		<?
		if (
...
<script>
  ...
  var timerDelete = setInterval(function () {
    $.each(items,function(){
      if($(this).find('.basket-items-list-item-warning-container').length == 1){
