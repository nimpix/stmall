...
//Увеличиваем счетчик просмотров свойство SHOW_COUNTER
		...
		<div class="soc-vk">
			...
			<div class="soc-repost">
				...
				<?
					...
					echo "<span class='repost-count'>Количество репостов ".$resultVK."</span>";
				?>
					</div>
			</div>
		</div>
...
//	document.write(VK.Share.button(false,{type: "round", text: "Сохранить"}));
	// document.getElementById('soc-share').innerHTML = VK.Share.button(link, {type: 'link'});
</script>
