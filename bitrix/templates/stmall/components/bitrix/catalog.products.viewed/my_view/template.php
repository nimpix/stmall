...
<script>
	...
	var linkList = $('.is-viewed .product-item-image-wrapper');

	$.each(linkList,function () {
        let currentHref = $(this).attr('href');  //is-viewed .product-item-image-wrapper
        $(this).attr('href',"http://st-mall.ru/catalog/"+currentHref);
