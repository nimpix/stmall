...
<div class="form-table data-table">
    <div class="form-title">Сэкономьте свое время - оставьте заявку
        на подбор оптимального
        для вас тренажера!</div>
...
?>
	...
	<div class="button-group">
				...
				<input <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="Жми" />
...
<script>
  $('#mobinput').attr('required','required');
</script>