...
?><ul><?
    if ('Y' == $arParams['SHOW_PARENT_NAME'] && 0 < $arResult['SECTION']['ID'])
    {
        ...
        ?><div><span>Вас могут заинтересовать</span></div><?
    }
    if (0 < $arResult["SECTIONS_COUNT"])
    {
        ...
        <ul class="<? echo $arCurView['LIST']; ?>">
            ...
            ?><li id="<?=$this->GetEditAreaId($arSection['ID']);?>"><a href="http://st-mall.ru/catalog/<? echo $arResult['SECTIONS'][$razdelCount]['CODE']; $razdelCount++;?>/"><? echo $arSection["NAME"];?><?
