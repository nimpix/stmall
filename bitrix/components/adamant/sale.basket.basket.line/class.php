	...
	public function executeComponent()
	{
		...
		else
		{
			...
			if ($this->arParams['SHOW_NOTAVAIL'] == 'N')
				$arFilter['CAN_BUY'] = 'Y';
				$arFilter['FUSER_ID'] = $this->currentFuser;
				$arFilter['DELAY'] = 'N';
			...
			$dbItems = CSaleBasket::GetList(
				...
				false,
				false,
				array("ID", "NAME", "CALLBACK_FUNC", "MODULE", "PRODUCT_ID", "QUANTITY", "PRICE")
			);	
			...
			{
			    $qty+=$arItems["QUANTITY"];
			    $prc += $arItems["PRICE"]*$arItems["QUANTITY"];
			}
			
			$this->arResult["NUM_PRODUCTS"] = $qty;			
			$this->arResult["TOTAL_PRICE"] = $prc;	
		}
